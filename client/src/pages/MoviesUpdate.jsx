...
class MoviesUpdate extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      categories: [
        ...
        { id: 3, value: "Sci-Fi", checked: false },
  ...
  handleSubmit = (event) => {
    ...
    const { title, overview, poster, release_date, genres, id } = this.state;
  ...
  render() {
    const { title, overview, poster, release_date, categories } = this.state;
